...
exports.Certificados = void 0;
var typeorm_1 = require("typeorm");
var class_validator_1 = require("class-validator");
var EstadoDocumento_1 = require("./EstadoDocumento");
var Certificados = /** @class */ (function () {
    function Certificados() {
    }
    __decorate([
        typeorm_1.PrimaryGeneratedColumn(),
        __metadata("design:type", Number)
    ], Certificados.prototype, "cod_cer", void 0);
    __decorate([
    ...
    ], Certificados.prototype, "id_est_doc", void 0);
    __decorate([
        typeorm_1.Column("text"),
        class_validator_1.IsNotEmpty(),
        __metadata("design:type", String)
    ], Certificados.prototype, "url", void 0);
    __decorate([
        typeorm_1.Column(),
        typeorm_1.CreateDateColumn(),
        __metadata("design:type", Date)
    ], Certificados.prototype, "fecha", void 0);
    Certificados = __decorate([
        typeorm_1.Entity()
    ], Certificados);
    return Certificados;
}());
exports.Certificados = Certificados;
